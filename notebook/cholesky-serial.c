...
symmetric positive-definite matrix, computed in serial.
...
Compile: gcc -g -Wall -O3 -lm -o cholesky-serial cholesky-serial.c

Usage:   ./cholesky-serial Matrix_Dimension
